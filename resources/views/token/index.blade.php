                ...
                <div class="row">
                    <div class="text-center">
                        <button type="button" class="btn btn-primary" onclick="generateToken()"
                            style="margin-bottom: 10px">Acak Token</button><br>
...
@push('script')
    <script>
        function generateToken() {
            ...
            const randomToken =
                `${generateRandomString(2, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')}${generateRandomString(2, '0123456789')}${generateRandomString(2, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')}`;
