        ...
        @foreach ($siswa as $data)
            <div class="col">
                <div class="card" style="position: relative;">
                    <img src="{{ asset('img/ktp/dpn.jpg') }}" style="width: 100%; position: absolute; z-index: -1;" alt="">
                    <div style="height: 30%;">
                        <div style="display: flex; flex-direction: row; align-items: center;">
                            <div style="width: 20%;">
                                <img src="{{ asset('img/website/logo/_1716541080.png') }}" style="width: 65%; margin-left: 17px" alt="">
                            </div>
                            <div style="width:60%; text-align: center; font-size: 11px; font-weight: bold; color: white; margin-top: 11px;">
            ...
            <div class="col">
                <div class="card" style="position: relative;">
                    <img src="{{ asset('img/ktp/blk.jpg') }}" style="width: 100%; position: absolute; z-index: -1;" alt="">
                    <div style="height: 30%;">
